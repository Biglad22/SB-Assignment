<template>
  <svg xmlns="http://www.w3.org/2000/svg" class="w-[1.5rem] h-auto" viewBox="0 0 24.367 30.379">
    ...
    <circle cx="59.377" cy="12.177" r="8" transform="translate(-47.2 0)" fill="none" stroke="#21b3ff" stroke-width="2"/>
  </svg>
